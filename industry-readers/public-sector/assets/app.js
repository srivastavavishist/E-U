  ...
  function renderHome() {
    ...
    hero.innerHTML = `
      ...
      <h1 class="hero-heading">
        <em>Energy &amp; Utilities</em> Intelligence Reader
      </h1>
  ...
  function buildCompanyCard(company) {
    ...
    card.innerHTML = `
      ...
      <div class="company-meta">
        <span class="company-meta-item">📍 ${company.hq}</span>
        <span class="company-meta-item">💰 ${company.marketCap}</span>
        <span class="company-meta-item">👥 ${company.employees}</span>
      </div>
  ...
  function openCompanyModal(company) {
    ...
    modal.innerHTML = `
      ...
      <div class="modal-ticker-row">
        ...
        <span class="modal-ticker" style="color:${color};background:${color}18;border:1px solid ${color}30">${company.ticker} · ${company.exchange}</span>
      </div>
